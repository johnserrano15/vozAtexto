...
Microphone.prototype.record = function() {
  ...
  navigator.getUserMedia({ audio: true },
    this.onMediaStream.bind(this), 
    this.onPermissionRejected.bind(this)); 
};
...
},{"./socket":4,"./views/displaymetadata":7}],3:[function(require,module,exports){
'use strict';
...
},{"./Microphone":1,"./utils":5,"./views":8}],4:[function(require,module,exports){
var utils = require('./utils');
var Microphone = require('./Microphone');
...
var initSocket = exports.initSocket = function(options, onopen, onlistening, onmessage, onerror, onclose) {
  ...
  socket.onerror = function(evt) {
    ...
    showError('Application error ' + evt.code + ': Por favor recarga el navegador');
    $.publish('clearscreen');
    onerror(evt);
  };
  ...
  socket.onclose = function(evt) {
    ...
    if (evt.code === 1011) {
      console.error('Server error ' + evt.code + ': Por favor recarga el navegador');
      return false;
    }
    if (evt.code > 1000) {
      console.error('Server error ' + evt.code + ': Por favor recarga el navegador');
...
},{"./Microphone":1,"./utils":5,"./views/showerror":11}],5:[function(require,module,exports){
(function (global){
...
},{"./animatepanel":6,"./displaymetadata":7,"./recordbutton":9,"./sessionpermissions":10,"./showtab":12}],9:[function(require,module,exports){
...
},{"../Microphone":1,"../handlemicrophone":2,"./showerror":11}],10:[function(require,module,exports){
